function main(config) {
  ...
  config["dns"] = {
    ...
    "fake-ip-filter":[
      ...
      "www.msftconnecttest.com", "*.bilibili.com", "*.bilivideo.com",
      "*.bilivideo.cn", "*.bilivideo.net", "*.hdslb.com", "*.biliapi.net",
      "*.biliapi.com", "*.mcdn.bilivideo.cn", "pemby.ednovas.org"
    ],
    "default-nameserver":[
      "system", "223.5.5.5", "119.29.29.29", "2400:3200::1", "2001:4860:4860::8888"
    ],
    "nameserver":[
    ...
    "proxy-server-nameserver":[
      ...
      "https://1.1.1.1/dns-query", "tls://223.5.5.5"
    ],
    "direct-nameserver": [],
    "nameserver-policy": {
  ...
  // 3. 覆写策略组 (Proxy Groups)
  // 注意：因为使用了 include-all: true，需要搭配 Mihomo (Clash Meta) 内核使用
  config["proxy-groups"] = [
    {
      "name": "🚀 代理选择",
      "type": "select",
      "proxies": ["DIRECT", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "🇨🇳 回国节点"],
      "include-all": true
    },
    {
      "name": "🤖 AIGC",
      "type": "select",
      "proxies": ["🇹🇼 台湾节点", "🇸🇬 狮城节点", "🇯🇵 日本节点", "🇺🇸 美国节点", "🚀 代理选择", "DIRECT"],
      "include-all": true
    },
    {
      "name": "📺 哔哩哔哩",
      "type": "select",
      "proxies": ["DIRECT", "🚀 代理选择", "🇨🇳 回国节点", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点"],
      "include-all": true
    },
    {
      "name": "📦 小黑盒",
    ...
    },
    {
      "name": "🖼️ 巴哈姆特",
      "type": "select",
      "proxies": ["🇹🇼 台湾节点", "🚀 代理选择", "🇭🇰 香港节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "🇨🇳 回国节点", "DIRECT"],
      "include-all": true
    },
    {
      "name": "🎮 Steam 登录/下载",
      "type": "select",
      "proxies": ["DIRECT", "🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "🇨🇳 回国节点"],
      "include-all": true
    },
    {
      "name": "🎮 Steam 商店/社区",
      "type": "select",
      "proxies": ["🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "🇨🇳 回国节点", "DIRECT"],
      "include-all": true
    },
    {
      "name": "🌩️ Cloudflare",
    ...
    },
    {
      "name": "🇨🇳 国内网站",
      "type": "select",
      "proxies": ["🇨🇳 回国节点", "DIRECT", "🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点"],
      "include-all": true
    },
    {
      "name": "🛑 拦截广告",
      "type": "select",
      "proxies": ["DIRECT", "REJECT", "🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "🇨🇳 回国节点"]
    },
    {
      "name": "🐟 漏网之鱼",
      "type": "select",
    ...
    },
    {
      ...
      "proxies": ["🇺🇸 美国自动", "DIRECT"],
      "include-all": true,
      "filter": "(?i)美|us|united states|america|los angeles"
    },
    {
      "name": "🇸🇬 狮城节点",
      "type": "select",
  ...
  // 4. 覆写路由规则 (Rules)
  config["rules"] =[
    "GEOSITE,category-ads-all,🛑 拦截广告",
    "DOMAIN,pemby.ednovas.org,😍 Comic",
    "DOMAIN,ee.ednovas.org,😍 Comic",
    "GEOSITE,18comic,😍 Comic",
    "GEOSITE,pixiv,😍 Comic",
    "GEOSITE,category-ai-!cn,🤖 AIGC",
    "GEOSITE,apple-intelligence,🤖 AIGC",
    "GEOSITE,category-bank-cn,💳 银行服务",
    "GEOSITE,hsbc,💳 银行服务",
    "GEOSITE,icbc,💳 银行服务",
    "GEOSITE,cnbc,💳 银行服务",
    ...
    "GEOSITE,bahamut,🖼️ 巴哈姆特",
    "GEOSITE,bilibili,📺 哔哩哔哩",
    "GEOSITE,bilibili2,📺 哔哩哔哩",
    "GEOSITE,biliintl,📺 哔哩哔哩",
    "GEOSITE,bilibili-cdn,📺 哔哩哔哩",
    "GEOSITE,acfun,📺 哔哩哔哩",
    "GEOSITE,xiaoheihe,📦 小黑盒",
    "GEOSITE,iqiyi,🌍 其他CN流媒体",
    "GEOSITE,youku,🌍 其他CN流媒体",
    "GEOSITE,douyin,🌍 其他CN流媒体",
    "GEOSITE,douyu,🌍 其他CN流媒体",
    "GEOSITE,huya,🌍 其他CN流媒体",
    "GEOSITE,onedrive,☁️ OneDrive",
    "GEOSITE,cloudflare,🌩️ Cloudflare",
    "GEOIP,cloudflare,🌩️ Cloudflare",
    "GEOSITE,category-scholar-!cn,🎓 学术网站",
    "DOMAIN-SUFFIX,cm.steampowered.com,🎮 Steam 登录/下载",
    "DOMAIN-SUFFIX,steamcontent.com,🎮 Steam 登录/下载",
    "DOMAIN-SUFFIX,steamserver.net,🎮 Steam 登录/下载",
    "DOMAIN-SUFFIX,client-download.steampowered.com,🎮 Steam 登录/下载",

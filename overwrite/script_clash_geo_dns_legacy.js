  ...
  config["proxy-groups"] =[
    {
      "name": "🚀 代理选择",
      "type": "select",
      "proxies":["🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "DIRECT"]
    },
    {
      "name": "🤖 AIGC",
      "type": "select",
    ...
    },
    {
      "name": "📺 哔哩哔哩",
      "type": "select",
      "proxies":["DIRECT", "🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点"]
    },
    {
      "name": "📦 小黑盒",
      "type": "select",
    ...
    },
    {
      "name": "🖼️ 巴哈姆特",
      "type": "select",
      "proxies":["🇹🇼 台湾节点", "🚀 代理选择", "🇭🇰 香港节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "DIRECT"]
    },
    {
      "name": "🎮 Steam 登录/下载",
      "type": "select",
    ...
    },
    {
      "name": "🎮 Steam 商店/社区",
      "type": "select",
      "proxies":["🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点", "DIRECT"]
    },
    {
      "name": "🌩️ Cloudflare",
      "type": "select",
    ...
    },
    {
      "name": "🛑 拦截广告",
      "type": "select",
      "proxies":["DIRECT", "REJECT", "🚀 代理选择", "🇭🇰 香港节点", "🇹🇼 台湾节点", "🇺🇸 美国节点", "🇸🇬 狮城节点", "🇰🇷 韩国节点", "🇯🇵 日本节点"]
    },
    {
      "name": "🐟 漏网之鱼",
      "type": "select",
